...
/**
 * In the book, this class would start a new Swing application. In 
 * this implementation, it more closely represents a single browser
 * session.
 */
public class ApplicationRunner {
	...
	public void showsSniperIsJoining(FakeAuctionServer auction) {
		driver.showsSniperStatus(String.format(STATUS_JOINING, auction.getItemId()));
	}
